...
namespace AvalonStudio.Projects.OmniSharp.MSBuild
{
    public partial class ProjectFileInfo
    {
        ...
        public static ProjectFileInfo Create(
            string filePath, string solutionDirectory, string sdksPath, MSBuildOptions options = null, ICollection<MSBuildDiagnosticsMessage> diagnostics = null)
        {
            ...
            var projectInstance = LoadProject(filePath, solutionDirectory, sdksPath, options, diagnostics, out var targetFrameworks);
        ...
        private static ProjectInstance LoadProject(
            string filePath, string solutionDirectory, string sdksPath,
            MSBuildOptions options, ICollection<MSBuildDiagnosticsMessage> diagnostics, out ImmutableArray<string> targetFrameworks)
        {
            ...
            var globalProperties = GetGlobalProperties(options, solutionDirectory, sdksPath);
            ...
            try
            {
                ...
                var buildResult = projectInstance.Build(TargetNames.Compile,
                    new[] { new MSBuildLogForwarder(diagnostics) });
        ...
        public ProjectFileInfo Reload(
            string solutionDirectory, string sdksPath,
        ...
        private static Dictionary<string, string> GetGlobalProperties(MSBuildOptions options, string solutionDirectory, string sdksPath)
        {
